                    ...
                    <div class="card-body justify-content-center">
                        <form method="POST" action="/admin/packages" id="package_form" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-4">
                                    <textarea form="package_form" class="form-control @error('description') is-invalid @enderror" name="description" value="{{ old('description') }}" description required autocomplete="description"></textarea>
